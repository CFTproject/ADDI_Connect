...
response = WS.sendRequest(findTestObject('ROC_Activity_Hdb_1979/Activity_Controller_Verify_Response_1979', [('Activity_URL') : URLS]))

WS.verifyResponseStatusCode(response, 200)

WS.verifyElementPropertyValue(response, '[0].databaseName', 'NAF')

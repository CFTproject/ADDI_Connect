...
response = WS.sendRequest(findTestObject('ROC_Activity_Hdb_1979/Roc_hogan_connector_activity_Hdb_1979'))
...
//WS.verifyElementPropertyValue(response, 'results[0].resolutions[0].target.annText', '1979')

WS.verifyElementPropertyValue(response, 'results[0].resolutions[0].target.value', 'NAF')
...
String activity_url = 'http://localhost:9090/hogan-connector/activity/0000001979' 
//+ activityid

println('activity_url is :- ' + activity_url)

WS.callTestCase(findTestCase('ROC_Activity_Hdb_1979/Activity_Controller_Verify_Response_1979'), [('URLS') : activity_url, ('D_Name') : DataBase_Name], FailureHandling.CONTINUE_ON_FAILURE)

...
//WS.verifyElementPropertyValue(response, 'results[0].resolutions[0].resources[0].annText', '9')
...
String activity_url = 'http://localhost:9090/hogan-connector/activity/0000000009'
// + activityid

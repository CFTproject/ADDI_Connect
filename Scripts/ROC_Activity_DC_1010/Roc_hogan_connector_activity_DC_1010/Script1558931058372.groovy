...
//WS.verifyElementPropertyValue(response, 'results[0].resolutions[0].resources[0].annText', '1010')
...
String activity_url = 'http://localhost:9090/hogan-connector/activity/0000001010' 
//+ activityid
